...
const PlantCard = ({name, image,_id}) => {
  return (
    <>
    ...
    <div className="article-wrapper">
      ...
      <div className="article-body">
        <h2>{name}</h2>
        <Link to={`/esquejes/detalles/${_id}`} className="read-more">
          Ver más <span className="sr-only">tengo que llevar a la pag del esqueje</span>
