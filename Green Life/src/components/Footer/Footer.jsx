                    ...
                    <Row className='bg-success text-white p-4'>
                        <Col className='mx-5'>
                            <Stack>
                                ...
                                <div>
                                    ...
                                    <svg className='mx-4' xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-twitter-filled" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#000000" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path
                                    ...
                                    <svg className='mx-4' xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-instagram" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#000000" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <svg className='mx-4'xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-youtube-filled" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#000000" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path
                        ...
                        <Col>
                            <Nav className='flex-column fs-4'>
                                ...
                                <NavLink href='#' className='text-white fs-6'>Sobre nosotros</NavLink>
                                <NavLink href='#' className='text-white fs-6'>Contáctanos</NavLink>
                            </Nav>
                        </Col>   
                        <Col>
                            <Nav className='flex-column fs-4'>
                        ...
                        <p className='text-center'>Green Life© - All rights reserved</p>            
                    </Row>
             </Container>
        </footer>
    );
