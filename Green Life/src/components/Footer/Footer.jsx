        ...
        <footer>
             <Container fluid>
                    <Row className='bg-success text-white p-4'>
                        ...
                        <Col  className='md-3 sm-6'>
                            ...
                            <div className='direction'>
                                ...
                                <ul className='list-unstyled'>
                                    <li>Avenida Benítez, 8, 53º</li>
                                    <li>+34 905 000 458</li>
                                    <li>contanct@greenlife.com</li>
                                </ul>
                            </div>
                        ...
                        {/*Columna 2 */}
                        <Col md={3} sm={6} className='link'>
                            <h6><Link to='/eventos'>Eventos</Link></h6>
                        </Col>

                        {/*Columna 3 */}
                        <Col className='md-3 sm-6'>
                            <h6><Link to='/esquejes'>Esquejes</Link></h6>
                        </Col> 

                        {/*Columna 4 */}  
                        <Col className='md-3 sm-6'>
                            <h6><Link to='/sobrenosotro'>Más info</Link></h6>
                        </Col> 

                        {/*Columna 5 */}
                        <Col className='md-3 sm-6'>
                            <h6><Link to='#'>Próximos eventos</Link></h6>
                        </Col>  
                        
                        <div className='footer-bottom'>
                            <p>&copy;{new Date().getFullYear()} Green Life - All rights reserved</p>                       
                        </div>
